...
cd repo/
echo "⚙️ Build EIP Client image and tag it as '$DOCKER_USERNAME/env-substitution:${REVISION}_$arch'..."
sudo docker build ./ -t $DOCKER_USERNAME/env-substitution:${REVISION}_${arch}
EOF
done
